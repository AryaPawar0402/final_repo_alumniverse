...
public class ConnectionService {
    ...
    public List<ConnectionPendingDTO> getPendingRequestsDTO(Long alumniId) {
        ...
        return pendingList.stream().map(c -> {
            ...
            StudentDTO dto = new StudentDTO(
                    student.getId(), student.getEmail(), firstName, lastName, profilePhoto, about, branch, batch
            );
    ...
    // FIXED: Get all accepted connections where alumni is involved in any role
